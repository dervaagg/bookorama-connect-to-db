...
?>
    ...
    <div class="card mt-4" style="margin-left: 19%; margin-right: 1%;">
...
<?php
    ...
    $query = "SELECT o.orderid AS OrderID, c.name AS Name, o.amount AS Amount, o.date AS order_date, oi.isbn AS ISBN, oi.quantity AS Quantity, b.title AS Title FROM orders o 
